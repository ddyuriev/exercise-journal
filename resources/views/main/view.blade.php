...
{{--            </div>--}}
            ...
            <div class="row mb-2">
                <div class="text-start sort-field" style="width: 4%">#</div>
                <div class="text-start" style="width: 28%">упраж&shyнение</div>
                <div class="text-start" style="width: 12%">повто&shyрений</div>
                <div class="text-start" style="width: 40%"><span class="">комментарий</span></div>
                <div class="" style="width: 16%"></div>
            </div>
...
{{--                @endforeach--}}
                ...
                @foreach($user_physical_exercises as $user_physical_exercise)
                    <div draggable="true" class="row block-body">
                        ...
                        <div class="text-start sort-field physical-exercise-{{$user_physical_exercise['id']}}" style="width: 4%">
                            {{$user_physical_exercise['intraday_key']}}
                        </div>
                        <div class=" text-start physical-exercise-{{$user_physical_exercise['id']}}" style="width: 28%">
                            <span>{{$user_physical_exercise['physical_exercises']['name']}}</span>
                        </div>
                        ...
                        <div class="delete-control" style="width: 6%">
                            <div class="w-50 h5">
                                <i id="i-element-{{$user_physical_exercise['id']}}" class="bi bi-x"></i>
                            </div>
                        </div>
